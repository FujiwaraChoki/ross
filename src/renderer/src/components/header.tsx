...
export default function Header(): ReactElement {
  const { threads, activeThreadId, activeTab, isSidebarOpen, setIsSidebarOpen } = useCodexStore()
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        {isSkillsTab && (
          <div className="flex items-center gap-2 min-w-0">
            <span className="text-[13px] font-medium truncate">Skills</span>
            <span className="text-[12px] text-muted-foreground shrink-0">Workspace</span>
          </div>
        )}
        {!isSkillsTab && (
          <div className="flex items-center gap-2 min-w-0">
      ...
      <div className="flex items-center gap-1 no-drag shrink-0">
        {isSkillsTab && (
          <span className="px-2 py-1 text-[11px] border border-border rounded-md text-muted-foreground">
            Loaded from Codex
          </span>
        )}
        {!isSkillsTab && (
          <>
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-[12px] text-foreground border border-border rounded-md hover:bg-secondary transition-colors"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
